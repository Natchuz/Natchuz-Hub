...
import com.natchuz.hub.paper.regions.*;
...
public class RegionParserTest {
    ...
    public void testForcedUnion() {
        ...
        assertEquals(new Union(new CylinderRegion(new Vector(0.1, 0.5, -2), 4, 1),
                        new CuboidRegion(5, 2, 1, 6, 7, 4)),
                RegionParser.parse("cylinder(0.1 0.5 -2 4 1); cuboid(5 2 1 6 7 4);", true));
        assertEquals(new Union(new SphereRegion(new Vector(5, 5, -2), 4),
    ...
    public void testRegularParser() {
        ...
        assertEquals(new SphereRegion(new Vector(2.1, 4.1, -1), 4),
                RegionParser.parse("sphere(2.1 4.1 -1 4);"));

        assertNotEquals(new SphereRegion(new Vector(2.1, 4.1, -1), 4),
